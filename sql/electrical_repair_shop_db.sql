...
-- ----------------------------
INSERT INTO `system_configs` VALUES ('SC296281291291234304', 'after_sales.valid_days', '7', 2, '订单完成后允许申请售后的天数，同时用于售后保护期资金释放。', 'after_sales', 1, 0, 1774706164484, 1774707356262, 2, 0);
INSERT INTO `system_configs` VALUES ('SC296281291299622913', 'after_sales.max_image_count', '5', 2, '用户提交售后时最多可上传的图片数量。', 'after_sales', 1, 0, 1774706164484, 1774707356274, 2, 0);
INSERT INTO `system_configs` VALUES ('SC296281291303817218', 'account.cancel_grace_days', '7', 2, '用户或师傅提交注销申请后，可撤销注销的保留天数。', 'account', 1, 0, 1774706164484, 1774707356280, 2, 0);
INSERT INTO `system_configs` VALUES ('SC296281291308011523', 'account.cancel_data_retention_days', '30', 2, '账号注销记录保留时长。', 'account', 1, 0, 1774706164484, 1774707356286, 2, 0);
INSERT INTO `system_configs` VALUES ('SC296281291308011524', 'auth.code_expire_minutes', '5', 2, '邮箱验证码在 Redis 中的有效分钟数，同时同步展示到邮件模板。', 'auth', 1, 0, 1774706164484, 1774707356292, 2, 0);
INSERT INTO `system_configs` VALUES ('SC296281291308011525', 'order.appointment.default_days', '7', 2, '前端默认展示的预约日期范围。', 'order', 1, 0, 1774706164484, 1774707356298, 2, 0);
INSERT INTO `system_configs` VALUES ('SC296281291312205830', 'order.appointment.max_days', '30', 2, '用户最多可预约到未来多少天。', 'order', 1, 0, 1774706164484, 1774707356305, 2, 0);
INSERT INTO `system_configs` VALUES ('SC296281291316400135', 'order.appointment.min_lead_minutes', '60', 2, '用户选择预约时间时，必须至少提前的分钟数。', 'order', 1, 0, 1774706164484, 1774707356311, 2, 0);
INSERT INTO `system_configs` VALUES ('SC296281291320594440', 'door_qr.fallback_expire_hours', '24', 2, '无预约时间时，上门二维码默认有效小时数。', 'door_qr', 1, 0, 1774706164484, 1774707356321, 2, 0);
INSERT INTO `system_configs` VALUES ('SC296281291320594441', 'door_qr.after_appointment_expire_hours', '2', 2, '二维码在预约时间之后继续保持有效的小时数。', 'door_qr', 1, 0, 1774706164484, 1774707356329, 2, 0);
INSERT INTO `system_configs` VALUES ('SC296281291324788746', 'door_qr.min_valid_hours', '2', 2, '二维码生成后，从当前时间起至少保留有效的小时数。', 'door_qr', 1, 0, 1774706164484, 1774707356336, 2, 0);
...
INSERT INTO `system_configs` VALUES ('SC296294599893323776', 'email_template.auth_code_file_id', 'FI296294599729745920', 1, '验证码邮件模板当前启用的文件ID', 'email_template', 1, 0, 1774709337500, 1774709337500, 1, 0);
